...
const projects = [
    {
    title: "ZipURL",
    desc: "Custom URL shortener with analytics, LRU cache integrated for performance, easy copy/delete functionality, and a minimal interface.",
    image: "/projects/Link Lite Image.jpg",
    live: "https://zip-url-eight.vercel.app/",
    github: "https://github.com/arnav-343-agarwal/ZipURL",
    stack: ["React.js", "TailwindCSS", "Express.js", "Hooks", "Redis"],
  },
  {
            ...
            <Card className="bg-neutral-950 border border-neutral-800 hover:shadow-purple-700/30 hover:scale-[1.02] transition-all duration-300">
              ...
              <CardFooter className="flex justify-between mt-2">
                <Button
                  variant="outline"
                  asChild
                  className="text-purple-500 border-purple-600 hover:bg-purple-900"
                >
